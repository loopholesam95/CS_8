...
public class Class_Routine extends AppCompatActivity
    ...
    public void routine(View view) {
        ...
        ImageView imageView = (ImageView) findViewById(R.id.routine_image_view);
        imageView.setImageResource(R.drawable.cs8_routine);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
       ...
       if (id == R.id.nav_facutly_details)
        {
            startActivity(new Intent(Class_Routine.this,Faculty_Details.class));

        }
        else if (id == R.id.nav_student_details)
        {
            startActivity(new Intent(Class_Routine.this,Student_details.class));

        }
        else if (id == R.id.nav_notice)
        {
            startActivity(new Intent(Class_Routine.this,Notice.class));
        }
        else if (id == R.id.nav_latest_details)
        {
            startActivity(new Intent(Class_Routine.this,Latest_details.class));
        }
