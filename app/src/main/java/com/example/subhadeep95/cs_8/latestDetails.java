...
public class latestDetails extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            startActivity(new Intent(latestDetails.this,facultyDetails.class));

        }
        else if (id == R.id.nav_student_details)
        {
            startActivity(new Intent(latestDetails.this,studentDetails.class));
